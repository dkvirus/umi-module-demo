...
var Exception404Page =
/*#__PURE__*/
function (_React$Component) {
  _inherits(Exception404Page, _React$Component);

  function Exception404Page() {
    _classCallCheck(this, Exception404Page);

    return _possibleConstructorReturn(this, _getPrototypeOf(Exception404Page).apply(this, arguments));
  }

  _createClass(Exception404Page, [{
    key: "render",
